...
export default function OnboardingModal() {
  ...
  const handleAccept = async () => {
    ...
    setStep("applying");
    setApplyStatus("Creating new buckets...");
    ...
    try {
      ...
      setApplyStatus("Classifying your emails...");
          ...
          for (const line of lines) {
            ...
            try {
              ...
              if (evt.phase === "llm-progress") {
                ...
                setApplyStatus(
                  ruleCount > 0
                    ? `Rules matched ${ruleCount}, AI classifying ${evt.needsLLM} more...`
                ...
                setApplyStatus(`Created new buckets: ${evt.buckets?.join(", ")}`);
                queryClient.invalidateQueries({ queryKey: ["buckets"] });
              }
